package com.example.biirr.util
...
class CirleImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(
        ...
        mBorderWidth = a.getDimensionPixelSize(
            R.styleable.CirleImageView_civ_border_width,
            DEFAULT_BORDER_WIDTH
        )
        mBorderColor = a.getColor(R.styleable.CirleImageView_civ_border_color, DEFAULT_BORDER_COLOR)
        mBorderOverlay =
            a.getBoolean(R.styleable.CirleImageView_civ_border_overlay, DEFAULT_BORDER_OVERLAY)
